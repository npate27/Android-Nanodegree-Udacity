...
import com.neelhpatel.popular_movies_stage_2.BuildConfig;
...
public class NetworkUtils {
    ...
    private static final String MOVIE_VIDEOS =
        "videos";
    private static final String MOVIE_REVIEWS =
        "reviews";
    ...
    /**
     * Generates URL that will return more specific JSON pertaining to a specific movie's
     * trailers via it's movie id field
     *
     * @param movieId movie to be queried further
     * @return URL which will return trailers for movie
     */
    public static URL getMovieTrailers(int movieId) {
        Uri movieDetailUri = Uri.parse(MOVIES_BASE_URL).buildUpon()
    ...
    /**
     * Generates URL that will return more specific JSON pertaining to a specific movie's
     * reviews via it's movie id field
     *
     * @param movieId movie to be queried further
